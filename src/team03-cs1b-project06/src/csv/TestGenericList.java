 ...
 *  of Node objects.
 *
 * @author Foothill College, Bita Mazloom, Selahittin Saytaş, Mary Markart
 */
...
{	
	...
	{	
		...
		while(true)
		{
			...
			try
			{
				System.out.println("Select an indicator to parse. Enter a number between 0 to 6.");
				...
				System.out.println("5. World Female Population (short for debugging)");
				System.out.println("6. World Female Population");
	...
	public static void main(String[] args) 
	{
		...
		// Extra Credit Portion
		final String [] FEMALE_POPULATION_SHORT = {"resources/female_population_short.csv"};
		...
		else if (selection == 5 || selection == 6)
		{
			...
			filenames = selection == 5 ? FEMALE_POPULATION_SHORT : FEMALE_POPULATION;
		}
		else
		{
