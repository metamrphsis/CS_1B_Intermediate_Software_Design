...
public class Country
{
    ...
    LinkedList<Indicator> indicators;
...
//    }
    ...
    {
        int startYear = indicators.getIndex(0).getYear(); //indicators[0].year
        return startYear;
    }
    ...
    public int getEndYear()
    {
        ...
        int endYear = getStartYear() + indicators.getSize() -1;
    ...
    public Indicator getIndicatorForYear(int requestedYear)
    {
        ...
        int endYear = startYear + indicators.getSize();
        ...
        return indicators.getIndex(moveToIndex);
    }
    ...
    public void setIndicatorForYear(int requestedYear, Indicator dataForOneYear)
    {
        ...
        {
            indicators.insertAtIndex(dataForOneYear, 0);
            return;
        }
...
//        }
        ...
        else
        {
            ...
            indicators.insertAtIndex(dataForOneYear, index);
        }
    }
...
//
//        Indicator foundCountry = null;
//
//        while(itr.hasNext())
//        {
//            Indicator eachCountry = itr.next();
//
//            if(eachCountry.equals("India"))
//            {
//                foundCountry = "India";
//                break;
//            }
...
//        }
        ...
        int startingYear = indicators.getIndex(0).getYear();

        int startYear = getStartYear();
        int endYear = startYear + indicators.getSize() - 1;
        //int endYear = indicators[indicators.length - 1].year;
        int startingPos;
        int endingPos;
        ...
        {
            output[i] = indicators.getIndex(j);
            j++;
        }
     ...
     * indicators array. The method uses the enhanced for loop
     * (for-each loop) to traverse the linked list of indicator objects
    ...
    public String toString()
    {
        ...
        output.append(nameOfCountry);

        for(Indicator element : indicators)
        {
            output.append(String.format("%20s", element));
        }
    ...
    /**
     * The method adds an Indicator object to the end of years list
     * Receives one argument. Does not return anything
     * @param dataForOneYear    An Indicator object for the new data
     *                          to add
     */
    public void addIndicator(Indicator dataForOneYear)
    {
        if(indicators.contains(dataForOneYear) != null)
        {
            return;
        }
        indicators.add(dataForOneYear);
    }
}
